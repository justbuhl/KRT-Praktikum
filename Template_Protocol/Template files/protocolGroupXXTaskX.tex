...
\author{\underline{M. Löhning},} 
\author{C. Maier} 
% \author{}

\begin{abstract}                          % Abstract of not more than 250 words.
This template gives instructions on how to write a protocol for the MSc laboratory course ``Praktikum Konzepte der Regelungstechnik'' at the IST. Use this document to write your protocol with \LaTeX.
\end{abstract}

\end{frontmatter}

\section{Introduction}
This document explains how a protocol of the master laboratory course at the IST should be written. Furthermore, the corresponding tex-file serves as a template for the protocols.
