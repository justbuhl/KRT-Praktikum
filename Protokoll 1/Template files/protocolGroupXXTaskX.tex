...
$l_{Massenmittelpunkt}$ & -- & Abstand Rotationsachse um Elevation Achse zum Massenmittelpunkt des Armes und des Helikopters \\ \hline
\end{tabular}
\end{table}
...
Es fehlt noch die beschreibung von Fg
